function agregarNuevaOrden(
  ...
  // Obtener el número de pedido actual en localStorage
  let numeroPedido = localStorage.getItem("numeroPedido");

  // Verificar si el número de pedido actual es igual al pedidoNumero
  if (numeroPedido == pedidoNumero) {
    alert("El pedido ya está en el carrito.");
    return;
  } else {
